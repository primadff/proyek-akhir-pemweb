  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          <form style="width: 23rem;">
            ...
            <div class="form-outline mb-4">
              <input type="email" id="form2Example18" class="form-control form-control-lg" placeholder="Email Address" />
              <label class="form-label sr-only" for="form2Example18"></label>
            </div>

            <div class="form-outline mb-4">
              <input type="password" id="form2Example18" class="form-control form-control-lg" placeholder="Password" />
              <label class="form-label sr-only" for="form2Example18"></label>
            </div>
      ...
      <div class="col-sm-6 px-0 d-none d-sm-block">
        <img src="{{ asset('assets/img/pizza-bg.jpg') }}"
